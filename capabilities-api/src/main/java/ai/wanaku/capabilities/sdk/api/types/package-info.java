 ...
 * Key types include:
 * <ul>
 *   <li>{@link ai.wanaku.capabilities.sdk.api.types.WanakuEntity} - Base interface for all entities</li>
 *   <li>{@link ai.wanaku.capabilities.sdk.api.types.ToolReference} - Tool capability references</li>
 *   <li>{@link ai.wanaku.capabilities.sdk.api.types.ResourceReference} - Resource capability references</li>
 *   <li>{@link ai.wanaku.capabilities.sdk.api.types.ForwardReference} - Forward proxy references</li>
 *   <li>{@link ai.wanaku.capabilities.sdk.api.types.Namespace} - Namespace entities for logical grouping</li>
